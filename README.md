...
1. **[Dataset split](https://drive.google.com/file/d/1s_hAUwfD-Uz8yqlx3jULA_HX3_qSRTPb/view?usp=share_link)**: This is the Training / Test dataset split used in the MAIR experiment.
    However, since this split is not divided per scene, we strongly recommend using this [Training](https://drive.google.com/file/d/1ZhHaOPtnICGnEp9cgXT0HPaEm2SkdIJJ/view?usp=sharing) and [Test](https://drive.google.com/file/d/11HNfjg50Ku5ufEwiLzvRJ_SVzsk0eYU2/view?usp=sharing) dataset split.
